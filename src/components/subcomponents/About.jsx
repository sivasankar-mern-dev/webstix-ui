  ...
  return (
    <div className={classes.root}>
      <div className={classes.container}>
        <Typography className={classes.title} gutterBottom>Why <b>Webstix</b> is different</Typography>
        ...
        <Button className={classes.btn} variant="outlined" color="primary">Learn more about Webstix <ArrowRight /></Button>
      </div>
